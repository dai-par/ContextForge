...
２．プロジェクトフォルダをアップロード（またはドラッグ＆ドロップ）<br>
３．Generate Context をクリック<br>
４．Copy all でクリップボードにコピー<br>
５．ChatGPT / Claude / Cursor などに貼り付ける<br>
...
<br>
なぜ作ったか<br>
AIを使って開発するとき、「このプロジェクト全体を理解した上でコードを書いて」と伝えたくても、ファイルを一個ずつ貼るのが面倒すぎた。それを解決したくて作りました。
